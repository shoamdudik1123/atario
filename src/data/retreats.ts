...
export const retreats: Retreat[] = [
  {
    ...
    included: [
      ...
      { key: 'guidance', title: 'הנחיה', text: 'ליווי צמוד לאורך הימים, בקבוצה קטנה' },
  ...
  },
  {
    ...
    included: [
      ...
      { key: 'guidance', title: 'הנחיה', text: 'ליווי תרגול בקבוצה קטנה ואישית' },
  ...
  },
  {
    ...
    included: [
      ...
      { key: 'guidance', title: 'הנחיה', text: 'ליווי רגיש בקבוצה קטנה במיוחד' },
